...
class Dual_Buttons extends Widget_Base {
	...
	protected function register_buttons_content_controls() {
		...
		$this->start_controls_section(
			'section_buttons',
			array(
				'label' => __('MP - Dual Button', 'four-widget'),
			)
		);
		...
		$repeater->add_control(
			'text',
			array(
				'label' => __('Text', 'four_widget'),
				'type' => Controls_Manager::TEXT,
				'default' => __('Click Me', 'four_widget'),
				'placeholder' => __('Click Me', 'four_widget'),
				'dynamic' => array(
					'active' => true,
				),
			)
		...
		$this->add_control(
			...
			array(
				...
				'default' => array(
					array(
						'text' => __('Get Started', 'four_widget'),
					),
					array(
						'text' => __('Try Me', 'four_widget'),
					),
				),
			)
		);
